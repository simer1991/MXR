...
const WhyChoose360 = () => {
  return (
    <div className='mxr__whychoose360 mxr__section simple_tabs'>
      <Container>
         ...
         <Tab  eventKey="Real Estate" title="Real Estate">
            ...
            <Tab eventKey='Automotive' title='Automotive'>
                <Row>
                    ...
                    <Col md={7} sm={12}>
                      <p>Lead the charge in automotive e-commerce sales with immersive VR 360 experiences. What if your potential customers could walk your showroom remotely, enjoying a highly engaging experience with all the information they need to hand, but without having to leave their home or office? With the help of VR anyone can make sure that a created model looks good enough, functions well, and is safe to use. Instead of spending a lot of money, time and efforts to build several different prototypes in real life, let VR 360 help you to save a lot of time and resources to study how a car or a boat can look and work.</p>
                    </Col>
                </Row>
            </Tab>
